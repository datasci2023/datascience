...
class TestProjectBasic(unittest.TestCase):
    ...
    def test_04_RelationalQueryProcessor(self):
        ...
        self.assertIsInstance(
            rel_qp.getAnnotationsWithBodyAndTarget("just_a_test", "another_test"),
            DataFrame,
        )
    ...
    def test_06_GenericQueryProcessor(self):
        ...
        ann_2 = generic.getAnnotationsToCanvas(
        ...
        ann_3 = generic.getAnnotationsToCollection(
        ...
        ann_4 = generic.getAnnotationsToManifest(
        ...
        ann_5 = generic.getAnnotationsWithBody(
        ...
        self.assertIsInstance(
            generic.getAnnotationsWithBodyAndTarget("just_a_test", "just_a_test"), list
        )
        ann_6 = generic.getAnnotationsWithBodyAndTarget(
            "https://dl.ficlit.unibo.it/iiif/2/45499/full/699,800/0/default.jpg",
        ...
        ann_7 = generic.getAnnotationsWithTarget(
            "https://dl.ficlit.unibo.it/iiif/2/28429/canvas/p3"
        )
        ...
        can_2 = generic.getCanvasesInCollection(
            "https://dl.ficlit.unibo.it/iiif/28429/collection"
        )
        ...
        can_2 = generic.getCanvasesInManifest(
            "https://dl.ficlit.unibo.it/iiif/2/28429/manifest"
        )
        self.assertIsInstance(can_2, list)
        for a in can_2:
        ...
        self.assertIsInstance(
            generic.getEntitiesWithTitle("just_a_test"), list
        ...
        ima_2 = generic.getImagesAnnotatingCanvas(
        ...
        man_2 = generic.getManifestsInCollection(
            "https://dl.ficlit.unibo.it/iiif/28429/collection"
        )
