...
type = URIRef(
    ""
)  # why this since it the json it addresses the class to which the item belongs?
label = URIRef("")
item = URIRef(
    ""
)  # i think this is viewed as a relation within the collection (see point below), so it's not an attribute (???)
title = URIRef("")
